        ...
        <form action="${pageContext.request.contextPath}/EditUserAccountServlet" method="post">
            ...
            <div class="data-row">
                <div class="user-data-display">
                    ...
                    <input class="form-control" name="new-password" type="password" id="password-display">
                </div>
                <div class="user-data-display">
                    <label for="repeat-password-display">Confirm password</label>
                    <input class="form-control" name="new-password-repeat" type="password" id="repeat-password-display">
                </div>
            </div>
