  ...
  <div id="login-content">
    ...
    <form id="form-login" action="${pageContext.request.contextPath}/LoginServlet" method="post" class="was-validated">
        <div class="input-form">
            ...
            <input type="text" required class="input-sign-in form-control" name="dni-email" placeholder="DNI/Email" onfocus="changeIconColorFocus('fa-user')" onfocusout="changeIconColorFocusOut('fa-user')">
