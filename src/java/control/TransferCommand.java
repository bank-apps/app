...
public class TransferCommand {
    ...
    public void process(UserAccount userAccount, Double amount, String toIBAN, String recipient, String concept) throws ServletException, IOException, ClassNotFoundException {
        Bank bank = new Bank();
        ...
        if (result.equals("OK")) {
            bankAccount.setBalance(DataBaseManager.SelectBalanceWithIBAN(fromIBAN));
